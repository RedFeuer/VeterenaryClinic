...
> Остальные функции (Запись к врачу, Медицинские карточки) отражены в схеме БД как проектирование/расширение, но в UI/логике могут быть не реализованы в MVP.
...
- **presentation**
  ...
  - `AppState.Content` (единое состояние экрана)
...
- `Appointment 0..1 — 0..1 MedicalRecord` (опционально: запись могла быть без предварительной записи и наоборот)
...
### Требования
- Android Studio (желательно актуальная)
- Android SDK 24+
- Gradle
- AGP 9+
